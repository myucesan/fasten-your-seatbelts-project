...
public class JDBC {
    ...
    public static void Insert(String generatedCode, String curDate) throws SQLException{
    ...
    private static String insertFoto(int last_id, String file) throws SQLException{
